...
// Miguel Chavez - Term Project Draft 2
// Data source: Personal coding study sessions, October 15 - November 18, 2025
...
// Source: Personal tracking data from October 15 - November 18, 2025
let dataset = [
    {date: "Oct 15", studyTime: 50, problemsSolved: 3, errorRate: 5, confidence: 0, frustration: 5, notes: "Loops practice, some bugs"},
    {date: "Oct 16", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 5, notes: ""},
    {date: "Oct 17", studyTime: 40, problemsSolved: 2, errorRate: 7, confidence: 1, frustration: 5, notes: "Loops practice, some bugs"},
    {date: "Oct 18", studyTime: 120, problemsSolved: 4, errorRate: 6, confidence: 1, frustration: 4, notes: "IF/ELSE statements, progress"},
    {date: "Oct 19", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 5, notes: ""},
    {date: "Oct 20", studyTime: 50, problemsSolved: 5, errorRate: 7, confidence: 1, frustration: 4, notes: "IF/ELSE statements, progress"},
    {date: "Oct 21", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 0, notes: ""},
    {date: "Oct 22", studyTime: 40, problemsSolved: 2, errorRate: 7, confidence: 1, frustration: 5, notes: "Loops practice, some bugs"},
    ...
    {date: "Oct 29", studyTime: 40, problemsSolved: 2, errorRate: 3, confidence: 4, frustration: 2, notes: "console.log() practice"},
    {date: "Oct 30", studyTime: 40, problemsSolved: 0, errorRate: 0, confidence: 4, frustration: 2, notes: "Concept learning (strings,)"},
    {date: "Oct 31", studyTime: 30, problemsSolved: 2, errorRate: 3, confidence: 4, frustration: 1, notes: "Data types"},
    ...
    {date: "Nov 3", studyTime: 50, problemsSolved: 8, errorRate: 2, confidence: 4, frustration: 1, notes: "Variables Let"},
    {date: "Nov 4", studyTime: 30, problemsSolved: 8, errorRate: 3, confidence: 4, frustration: 1, notes: "Variables cons, var practice"},
    {date: "Nov 5", studyTime: 50, problemsSolved: 8, errorRate: 4, confidence: 4, frustration: 1, notes: "String interpolation practice"},
    {date: "Nov 6", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 0, notes: ""},
    {date: "Nov 7", studyTime: 40, problemsSolved: 3, errorRate: 0, confidence: 5, frustration: 0, notes: ""},
    {date: "Nov 8", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 0, notes: ""},
    {date: "Nov 9", studyTime: 60, problemsSolved: 10, errorRate: 3, confidence: 5, frustration: 0, notes: "sorting Arrays"},
    {date: "Nov 10", studyTime: 60, problemsSolved: 4, errorRate: 0, confidence: 5, frustration: 1, notes: ".map() .filter()"},
    {date: "Nov 11", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 0, notes: ""},
    {date: "Nov 12", studyTime: 30, problemsSolved: 3, errorRate: 2, confidence: 4, frustration: 1, notes: "sorting Arrays"},
    {date: "Nov 13", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 0, notes: ""},
    {date: "Nov 14", studyTime: 40, problemsSolved: 4, errorRate: 3, confidence: 4, frustration: 0, notes: "arrays"},
    {date: "Nov 15", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 0, notes: ""},
    {date: "Nov 16", studyTime: 60, problemsSolved: 5, errorRate: 6, confidence: 5, frustration: 0, notes: "D3 append(), homework"},
    {date: "Nov 17", studyTime: 0, problemsSolved: 0, errorRate: 0, confidence: 0, frustration: 0, notes: "Arrow functions"},
    {date: "Nov 18", studyTime: 70, problemsSolved: 8, errorRate: 8, confidence: 5, frustration: 0, notes: "Lab 9"}
];
...
function buildScales(data) {
    ...
    // Source: D3 Scale Chromatic color schemes
 ...
 *   - Two legends explaining circle size (confidence) and color (frustration)
 *****/
function drawVisualization(data, drawing) {
    // Calculate inner dimensions for proper axis placement
    const innerWidth = svgWidth - (margin.left + margin.right);
    const innerHeight = svgHeight - (margin.top + margin.bottom);
    
    // Draw X axis (Problems Solved - represents Practice)
...
console.log("Term Project Draft 2 - Visualization complete!");